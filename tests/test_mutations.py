...
def test_create_default_registry_has_14_operators() -> None:
    """Default registry ships with exactly 14 first-party operators."""
...
def test_register_duplicate_overwrites() -> None:
    ...
    # Total count should remain 14 (replaced, not added)
    assert len(registry.list_all()) == 14
