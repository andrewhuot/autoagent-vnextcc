...
_ROLE_SKILL_LAYER: dict[SpecialistRole, str] = {
    ...
    SpecialistRole.EVAL_RUNNER: "none",
    SpecialistRole.LOSS_ANALYST: "none",
    SpecialistRole.OPTIMIZATION_ENGINEER: "build",
    SpecialistRole.INSTRUCTION_OPTIMIZER: "build",
    SpecialistRole.GUARDRAIL_OPTIMIZER: "build",
    SpecialistRole.CALLBACK_OPTIMIZER: "build",
...
_ROLE_TASK_TITLES: dict[SpecialistRole, str] = {
    ...
    SpecialistRole.EVAL_RUNNER: "Execute eval suite against the active config",
    SpecialistRole.LOSS_ANALYST: "Cluster failures and narrate loss patterns",
    SpecialistRole.OPTIMIZATION_ENGINEER: "Optimize from eval evidence",
    SpecialistRole.INSTRUCTION_OPTIMIZER: "Propose instruction-axis change card",
    SpecialistRole.GUARDRAIL_OPTIMIZER: "Propose guardrail-axis change card",
    SpecialistRole.CALLBACK_OPTIMIZER: "Propose callback-axis change card",
